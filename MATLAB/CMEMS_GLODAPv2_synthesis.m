...
for f=1:length(fn)
    ...
    elseif isnumeric(GLODAPv22019_info.(fn{f})); GLODAPv22019_info.(fn{f})=cellstr(num2str(GLODAPv22019_info.(fn{f})));
    end
end
...
GLODAPv22019.bottomdepthf=zeros(size(GLODAPv22019.salinityf));
GLODAPv22019.temperaturef=ones(size(GLODAPv22019.salinityf));
GLODAPv22019.doc1f=GLODAPv22019.docf;
...
for ec=1:length(unique_platform_code)
    ...
    filterdata=ismember(GLODAPv22019.Expocode,GLODAPv22019_info.Expocode(filterec));
    ...
    if exist([outdir,outputfile], 'file')
        ...
        cruisefilter=ismember(GLODAPv22019.cruise,whichcruises);
    end
    ...
    %% Input variables
    depthinglodap=GLODAPv22019.depth(cruisefilter);
    [depthin,inddepthin]=unique(depthinglodap);
    
    timeinglodapMATLAB = datenum(([GLODAPv22019.year1(cruisefilter),...
        GLODAPv22019.month1(cruisefilter),GLODAPv22019.day1(cruisefilter),...
        GLODAPv22019.hour1(cruisefilter),GLODAPv22019.minute1(cruisefilter),...
        zeros(size(GLODAPv22019.minute1(cruisefilter)))]));
    ...
    latinglodap = GLODAPv22019.latitude(cruisefilter);
    latin=latinglodap(indtimein);
    loninglodap=GLODAPv22019.longitude(cruisefilter);
    lonin=loninglodap(indtimein);
    
    for vv=1:length(vars)
        % Variables
        eval([vars{vv},'inglodap=round(GLODAPv22019.',['G2',invars{vv}],'(cruisefilter)*1000.);']);
        eval([vars{vv},'finglodap=GLODAPv22019.',['G2',invars{vv}],'f(cruisefilter);']);
